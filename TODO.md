...
- [ ] ho provato la web app su dispositivi mobile. Il frontend non è responsive, la barra del munù a sx non è a scomparsa, praticamente è inutilizzabile!
...
- [x] nella pagina di scambio eliminare sulla destra le impostazioni
- [x] nelle pagina impostazioni sezione ordinamento scrivere Decrescente come default
- [x] utilizzare questa favicon https://raw.githubusercontent.com/marcotondi/swappingscout/refs/heads/legacy-v1/client/img/favicon.ico
- [x] utilizzare solo il cappellone come logo, senza la scritta https://raw.githubusercontent.com/marcotondi/swappingscout/refs/heads/legacy-v1/client/img/logo.svg
- [ ] uniformare il logo di partecipante come è settato nel menù a sx
- [ ] Il testo della PWA deve essere tutto correttamente in italiano. Lo sviluppo deve essere fatto in inglese, così come le route devono essere in inglese
